  ...
  routes: [
    {
      ...
      children: [
        ...
        }, 
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () => import("@/views/app/role/IndexRole"),
            },
            // {
            //   path: "tableThree",
            //   name: "tableThree",
        ...
        {
          path: "/app/reportsale",
          component: () => import("@/views/app/reportsale/Index.vue"),
          children: [
            {
              path: "IndexSalesReport",
              name: "IndexSalesReport",
              component: () => import("@/views/app/reportsale/IndexSalesReport"),
            },
            {
              path: "IndexReportPurchase",
              name: "IndexReportPurchase",
              component: () => import("@/views/app/reportpurchase/IndexReportPurchase"),
            },
            {
              path: "IndexClientReport",
              name: "IndexClientReport",
              component: () => import("@/views/app/clientreport/IndexClientReport"),
            },
          ],
        },
        {
